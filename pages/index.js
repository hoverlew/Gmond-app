...
Page({
  ...
  Diamonds: function () {
    var that = this;
    ECApiHelper.GoodsListGet(null, 9, null, null, null, null, null, null, null, null, 1, function (response) {
      var list = JSON.parse(response.Body);
      var DiamondsData = that.data.DiamondsData;
      //改变数组形态
      var length = list.length >= 30 ? 30 : list.length;
      for (var i = 0; i < length; i += 3) {
        DiamondsData.push(list.slice(i, i + 3));
      }
      that.setData({
  ...
  gold: function () {
    var that = this;
    ECApiHelper.GoodsListGet(null, 11, null, null, null, null, null, null, null, null, 1, function (response) {
      var list = JSON.parse(response.Body);
      var goldData = that.data.goldData;
      //改变数组形态
      var length = list.length >= 30 ? 30 : list.length;
      for (var i = 0; i < length; i += 3) {
        goldData.push(list.slice(i, i + 3));
      }
      that.setData({
        goldData: goldData
      })
  ...
  Kgold: function () {
    var that = this;
    ECApiHelper.GoodsListGet(null, 12, null, null, null, null, null, null, null, null, 1, function (response) {
      var list = JSON.parse(response.Body);
      var KgoldData = that.data.KgoldData;
      //改变数组形态
      var length = list.length >= 30 ? 30 : list.length;
      for (var i = 0; i < length; i += 3) {
        KgoldData.push(list.slice(i, i + 3));
      }
      //console.log(KgoldData)
      that.setData({
        KgoldData: KgoldData
      })
  ...
  Platinum: function () {
    var that = this;
    ECApiHelper.GoodsListGet(null, 13, null, null, null, null, null, null, null, null, 1, function (response) {
      var list = JSON.parse(response.Body);
      var PlatinumData = that.data.PlatinumData;
      //改变数组形态
      var length = list.length >= 30 ? 30 : list.length;
      for (var i = 0; i < length; i += 3) {
        PlatinumData.push(list.slice(i, i + 3));
      }
      that.setData({
  ...
  */
  ...
  GoodsListGet: function () {
    var that = this;
    ECApiHelper.GoodsListGet(null, null, null, null, null, null, null, null, null, null, 1, function (response) {
      //console.log(response.Body);
      var list = JSON.parse(response.Body);
      //缓存数据到本地
      try {
